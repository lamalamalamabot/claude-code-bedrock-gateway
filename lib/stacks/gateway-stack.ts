...
export class GatewayStack extends cdk.NestedStack {
  ...
  constructor(scope: Construct, id: string, props: GatewayStackProps) {
    ...
    this.taskDefinition.taskRole.addToPrincipalPolicy(new iam.PolicyStatement({
      ...
      resources: [
        props.inferenceProfileArns.opus5,
    ...
    this.taskDefinition.addContainer('litellm', {
      ...
      environment: {
        ...
        INFERENCE_PROFILE_ARN_OPUS_5: props.inferenceProfileArns.opus5,
...
cfg = {
    'model_list': [
        {
            'model_name': 'global.anthropic.claude-opus-5',
            'litellm_params': {
                'model': 'bedrock/' + os.environ['INFERENCE_PROFILE_ARN_OPUS_5'],
            },
            'model_info': {
                'base_model': 'bedrock/global.anthropic.claude-opus-5',
            },
        },
        {
